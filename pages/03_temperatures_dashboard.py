...
min_temp_city_row = temps_df[temps_df["AvgTemperatureCelsius"] == min_temp]
max_temp_city_row = temps_df[temps_df["AvgTemperatureCelsius"] == max_temp]

min_temp_city = min_temp_city_row.iloc[0]["City"]
min_temp_date = min_temp_city_row.iloc[0]["Date"]

max_temp_city = max_temp_city_row.iloc[0]["City"]
max_temp_date = max_temp_city_row.iloc[0]["Date"]
